                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" novalidate="novalidate">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly id="cc-pament" name="cc-payment" type="text" class="form-control" aria-required="true" aria-invalid="false" value="${amount}">
                        </div>
                        ...
                        <div>
                            <button id="payment-button" type="click" class="btn btn-lg btn-info btn-block">
                                <i class="fa fa-lock fa-lg"></i>&nbsp;
                                <span id="payment-button-amount">Pay &#8377; ${amount}</span>
